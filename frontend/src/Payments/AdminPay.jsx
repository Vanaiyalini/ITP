    ...
    return (
        <div className="min-h-screen bg-gray-50 p-10 ">
            ...
            <Link to='/AdminDashboard'><button
                       ...
                       className="flex items-center gap-2 px-5 py-2 bg-blue-800 text-white rounded-full shadow-md hover:bg-blue-700 transition duration-300"
                   >
        ...
        <div className=" bg-gray-50 flex items-center justify-center p-4 mt-10">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mt-6 flex justify-end">
                            <button
                                ...
                                className="px-4 py-2 text-sm font-medium text-white bg-blue-800 rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
                            >
