    ...
    useEffect(() => {
        const fetchMessages = async () => {
            try {
                ...
                console.log(`Making request to: http://localhost:4000/ContactusOperations/getmsg/user/${userData._id}`);
                
                const response = await axios.get(
                    `http://localhost:4000/ContactusOperations/getmsg/user/${userData._id}`,
                    {
                        headers: {
                ...
                const receivedMessages = response.data.data || response.data.msg || [];
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4">
            <div className="max-w-4xl mx-auto">
                <h1 className="text-2xl font-bold mb-6 text-blue-600 text-center">My Messages</h1>
                <br />
                <button
               onClick={() => navigate(-1)}
